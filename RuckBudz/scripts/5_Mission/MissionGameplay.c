	...
	{        
		...
		if ( GetGame().GetInput().LocalPress("UARuckBudzToggle") && GetGame().GetUIManager().GetMenu() == NULL ) 
		{
			...
			if (m_RuckBudzState == 0) {  
				...
				m_RuckBudzwidget.SetIcon("RuckBudz\\data\\volume_mid.edds");
				...
				m_RuckBudzwidget.SetIcon("RuckBudz\\data\\volume_low.edds");
				...
				m_RuckBudzwidget.SetIcon("RuckBudz\\data\\volume_off.edds");
				...
				m_RuckBudzwidget.SetIcon("RuckBudz\\data\\volume_full.edds");
