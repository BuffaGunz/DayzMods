modded class InGameMenu 
{
	...
	{
		layoutRoot = GetGame().GetWorkspace().CreateWidgets("Ruckloadscreen/data/day_z_ingamemenu.layout");
		...
		m_DiscordButton			= layoutRoot.FindAnyWidget("feedbackbtn");
	...
	{
		GetGame().OpenURL("https://discord.gg/W35b8TKDU3"); //Change to your discord link 
	}
