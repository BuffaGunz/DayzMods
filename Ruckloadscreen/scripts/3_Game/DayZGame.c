modded class LoadingScreen {
	...
	void LoadingScreen(DayZGame game) {
		...
		m_ImageBackground.LoadImageFile(0, "Ruckloadscreen/data/Ruckloadscreen.edds");
...
modded class LoginQueueBase {
	...
	override Widget Init() {
		...
		imageWidgetBackground.LoadImageFile(0, "Ruckloadscreen/data/Ruckloadscreen.edds");
		return w;
	}
}
