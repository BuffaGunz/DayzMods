...
class CfgVehicles
{
    ...
    class BoneSkull: Inventory_Base
	{
		...
		model="\RuckModPack\Data\Bones\Bone_Old_skull";
		weight=1000;
		itemSize[]={2,3};
		inventorySlot[]=
		{
		...
		{
			"RuckModPack\Data\Bones\data\bones_old_skull_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"RuckModPack\Data\Bones\data\bones_old_skull.rvmat"
		};
		class DamageSystem
		{
			class GlobalHealth
