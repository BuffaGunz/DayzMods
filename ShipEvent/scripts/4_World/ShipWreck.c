class ShipWreck extends BuildingSuper
{
	...
	static void SpawnSite()
	{
		...
		ref array<string> containerTypes = { "ShipContainerRed", "ShipContainerBlue", "ShipContainerYellow", "ShipContainerOrange" };
		string selectedType = containerTypes.GetRandomElement();

		string keyName = "";
		switch (selectedType)
		{
			case "ShipContainerBlue": keyName = "ShippingContainerKeys_Blue"; break;
			case "ShipContainerRed": keyName = "ShippingContainerKeys_Red"; break;
			case "ShipContainerYellow": keyName = "ShippingContainerKeys_Yellow"; break;
	...
	static void FillContainerWithRandomLoot(EntityAI container)
	{
		...
		{
			case "ShipContainerRed":
			case "ShipContainerBlue":
			case "ShipContainerYellow":
			case "ShipContainerOrange":
				crateType = "RuckShipStorage";
				break;
